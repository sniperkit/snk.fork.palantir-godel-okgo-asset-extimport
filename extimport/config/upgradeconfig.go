...
import (
	...
	"github.com/sniperkit/snk.fork.palantir-godel-okgo-asset-extimport/extimport/config/internal/legacy"
	"github.com/sniperkit/snk.fork.palantir-godel-okgo-asset-extimport/extimport/config/internal/v0"
)
